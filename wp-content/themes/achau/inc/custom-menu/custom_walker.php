...
class rc_scm_walker extends Walker_Nav_Menu
{
	...
	{		   
	   ...
	   $output .= $indent . '<li id="achau-menu-item-'. $item->ID . '"' . $value . $class_names .'>';
	   ...
	   if($depth != 0)
	   {
		...
		$item_output .= '<span data-hover="'.$args->link_before .$prepend.apply_filters('the_title', $item->title, $item->ID).$append.'">';
